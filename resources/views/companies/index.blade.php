    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                    ...
                    <a class="btn btn-sm btn-primary" href="{{ route('companies.create') }}" data-bs-toggle="modal" data-bs-target="#add-contact"> New Task</a>
            ...
            @foreach ($companies as $item)
                <tr>
                       ...
                       <td><a class="fs-6 text-gray-800 text-hover-primary"
                           href="{{ route('companies.edit',$item->id) }}">{{$i+1}}</a></td>
                    <td><a class="fs-6 text-gray-800 text-hover-primary"
                           href="{{ route('companies.edit',$item->id) }}">{{ $item->company}}</a></td>
                    <td><a class="fs-6 text-gray-800 text-hover-primary"
                           href="{{ route('companies.edit',$item->id) }}"><span class="svg-icon svg-icon-3">
