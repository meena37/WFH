...
@else
      <a class="btn btn-sm btn-primary" href="{{ route('tasks.create') }}"> New Task</a><!--a class="btn btn-sm btn-warning" >InActive</a-->
@endif  
...
<div class="card-body pt-0">
	<table class="table align-middle table-row-dashed fs-6 gy-5"><thead>
        <tr>
	        ...
	        <td>{{ '8 hours' }}</td><td> {{ $loss_hour }}</td><td>{{ $nassigntime }}</td><td>{{ $available_hour }}</td><td>{{ $Entry_time }} min</td><td>{{ $idle }}</td></tr></table>
