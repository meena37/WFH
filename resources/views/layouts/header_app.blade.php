								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									...
									<span class="menu-link">
										...
										<a class="menu-link" href="#">
														...
														<span class="menu-title">Work List</span>
													</a>
													</span>
...
<!--begin::Wrapper-->
  ...
  $('#subcategory').on('show.bs.modal', function (event) {
...
$('#edit').on('show.bs.modal', function (event) {
      ...
      var button = $(event.relatedTarget) 
      var posting_date = button.data('mypostingdate') 
      var service_no = button.data('myserviceno') 
      var job_number = button.data('myjobnumber') 
      var customer_id = button.data('mycustomernumber') 
...
var job_number = button.data('myjobnumber') 
var customer_id = button.data('mycustomernumber') 
var servicing_times = button.data('myservicingtimes') 
var km_records = button.data('mykmrecords') 
var coupon_code = button.data('mycouponcode') 
var job_remarks = button.data('myjobremarks') 
...
modal.find('.modal-body #service_no').val(service_no);
modal.find('.modal-body #job_number').val(job_number);
modal.find('.modal-body #customer_id_1').val(customer_id);
modal.find('.modal-body #servicing_times').val(servicing_times);
modal.find('.modal-body #km_records').val(km_records);
modal.find('.modal-body #coupon_code').val(coupon_code);
modal.find('.modal-body #job_remarks').val(job_remarks);

modal.find('.modal-body #job_id').val(job_id);
})

$('#pending-edit').on('show.bs.modal', function (event) {
...
$('#done_edit').on('show.bs.modal', function (event) {

var button = $(event.relatedTarget) 
var posting_date = button.data('mypostingdate') 
var service_no = button.data('myserviceno') 
var job_number = button.data('myjobnumber') 
var customer_number = button.data('mycustomernumber') 
...
modal.find('.modal-body #service_no').val(service_no);
modal.find('.modal-body #job_number').val(job_number);
modal.find('.modal-body #customer_number').val(customer_number);
...
$('#inspection-edit').on('show.bs.modal', function (event) {
...
<!--- delete Jobcard ---->
$('#deletejobcard').on('show.bs.modal', function (event) {
...
$('#deletecustomer').on('show.bs.modal', function (event) {
      ...
      var cust_id = button.data('custid') 
      var modal = $(this)

      modal.find('.modal-body #cust_id').val(cust_id);
})
<!--- delete customer ---->
$('#deletevehicle').on('show.bs.modal', function (event) {

      var button = $(event.relatedTarget) 

      var vehicle_id = button.data('vehicleid') 
      var modal = $(this)
...
<!--- delete service Type ---->
$('#deletesertype').on('show.bs.modal', function (event) {
   ...
   modal.find('.modal-body #service_type_id').val(service_type_id);
})
<!--- delete brand ---->
...
<!--- delete year ---->
$('#deleteyear').on('show.bs.modal', function (event) {

      var button = $(event.relatedTarget) 

      var year_id = button.data('yearid') 
      var modal = $(this)

      modal.find('.modal-body #year_id').val(year_id);
})
<!--- delete classification ---->
$('#deleteclassification').on('show.bs.modal', function (event) {
...
$('#deletesubcategory').on('show.bs.modal', function (event) {
      ...
      var subcategory_id = button.data('subcategoryid') 
      var modal = $(this)
...
$('#deletestock').on('show.bs.modal', function (event) {
      ...
      var productitem_id = button.data('productitemid') 
      var modal = $(this)

      modal.find('.modal-body #productitem_id').val(productitem_id);
})
</script>
		<!--begin::Javascript-->
