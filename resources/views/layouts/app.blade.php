...
<head>
    ...
    <link href="{{  URL::asset('demo1/dist/assets/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet"
          type="text/css"/>
    <!--end::Page Vendor Stylesheets-->
    <!--begin::Global Stylesheets Bundle(used by all pages)-->
    <link href="{{  URL::asset('demo1/dist/assets/plugins/global/plugins.bundle.css') }}" rel="stylesheet"
          type="text/css"/>
    ...
    <div class="page d-flex flex-row flex-column-fluid">
        ...
        <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
            ...
            <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                <!--begin::Logo-->
                <a href="index.html">
                    <img alt="Logo" src="{{  URL::asset('demo1/dist/assets/media/logos/logo.jpeg') }}"
                         class="h-15px logo"/>
                </a>
                <!--end::Logo-->
                <!--begin::Aside toggler-->
                    ...
                    <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                        ...
                        <div class="menu-item menu-accordion">
                            ...
                            <span class="menu-link">
										...
										<a class="menu-link" href="{{ route('tasks.index') }}">Task List</a>
							...
							<span class="menu-link">
								...
								<a class="menu-link" href="{{ url('task-supervisor') }}">Superviser Task</a>
							</span>
                            ...
                            <div class="d-flex align-items-stretch flex-shrink-0">
                                                    ...
                                                    <div class="scroll-y mh-200px mh-lg-325px">
                                                        ...
                                                        <a href="#"
                                                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                            ...
                                                            <div class="symbol symbol-40px me-4">
                                                                <img src="{{  URL::asset('demo1/dist/assets/media/avatars/150-1.jpg') }}"
                                                                     alt=""/>
                                                            </div>
                                                            <!--end::Symbol-->
                                                            <!--begin::Title-->
                                                        ...
                                                        <a href="#"
                                                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                            <!--begin::Symbol-->
                                                            <div class="symbol symbol-40px me-4">
                                                                <img src="{{  URL::asset('demo1/dist/assets/media/avatars/150-3.jpg') }}"
                                                                     alt=""/>
                                                            </div>
                                                            <!--end::Symbol-->
                                                            <!--begin::Title-->
                                                        ...
                                                        <a href="#"
                                                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                            <!--begin::Symbol-->
                                                            <div class="symbol symbol-40px me-4">
                                                                <img src="{{  URL::asset('demo1/dist/assets/media/avatars/150-8.jpg') }}"
                                                                     alt=""/>
                                                            </div>
                                                            <!--end::Symbol-->
                                                            <!--begin::Title-->
                                                        ...
                                                        <a href="#"
                                                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                            <!--begin::Symbol-->
                                                            <div class="symbol symbol-40px me-4">
                                                                <img src="{{  URL::asset('demo1/dist/assets/media/avatars/150-12.jpg') }}"
                                                                     alt=""/>
                                                            </div>
                                                            <!--end::Symbol-->
                                                            <!--begin::Title-->
                                                            ...
                                                            <div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px"
                                                                                 src="{{  URL::asset('demo1/dist/assets/media/svg/misc/volicity-9.svg') }}"
                                                                                 alt=""/>
																		</span>
                                                            </div>
                                                            <!--end::Symbol-->
                                                        ...
                                                        <a href="#"
                                                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                            ...
                                                            <div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px"
                                                                                 src="{{  URL::asset('demo1/dist/assets/media/svg/misc/infography.svg') }}"
                                                                                 alt=""/>
																		</span>
                                                            </div>
                                                            <!--end::Symbol-->
                                                        ...
                                                        <a href="#"
                                                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                            ...
                                                            <div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px"
                                                                                 src="{{  URL::asset('demo1/dist/assets/media/svg/misc/leaf.svg') }}"
                                                                                 alt=""/>
																		</span>
                                                            </div>
                                                            <!--end::Symbol-->
                                                        ...
                                                        <a href="#"
                                                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                            ...
                                                            <div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px"
                                                                                 src="{{  URL::asset('demo1/dist/assets/media/svg/misc/tower.svg') }}"
                                                                                 alt=""/>
																		</span>
                                                            </div>
                                                            <!--end::Symbol-->
                                            ...
                                            <div class="tab-pane fade show active" id="kt_topbar_notifications_2"
                                                ...
                                                <div class="d-flex flex-column px-9">
                                                    ...
                                                    <img class="mh-200px" alt="metronic"
                                                         src="{{  URL::asset('demo1/dist/assets/media/svg/illustrations/work.svg') }}"/>
                                                    <!--end::Illustration-->
                                                </div>
                                                <!--end::Wrapper-->
                                            </div>
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="cursor-pointer symbol symbol-40px" data-kt-menu-trigger="click"
                                         ...
                                         data-kt-menu-flip="bottom">
                                        <img src="{{  URL::asset('demo1/dist/assets/media/avatars/150-2.jpg') }}"
                                             alt="metronic"/>
                                    </div>
                                    <!--begin::Menu-->
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="symbol symbol-50px me-5">
                                                    <img alt="Logo"
                                                         src="{{  URL::asset('demo1/dist/assets/media/avatars/150-2.jpg') }}"/>
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Username-->
                                                <div class="d-flex flex-column">
                                        ...
                                        <div class="menu-item px-5" data-kt-menu-trigger="hover"
                                            ...
                                            <a href="#" class="menu-link px-5">
														...
														<img class="w-15px h-15px rounded-1 ms-2"
                                                             src="{{  URL::asset('demo1/dist/assets/media/flags/united-states.svg') }}"
                                            ...
                                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="account/settings.html" class="menu-link d-flex px-5">
															<span class="symbol symbol-20px me-4">
																<img class="rounded-1"
                                                                     src="{{  URL::asset('demo1/dist/assets/media/flags/spain.svg') }}"
                                                                     alt="metronic"/>
															</span>Spanish</a>
                                                </div>
                                                <!--end::Menu item-->
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="account/settings.html" class="menu-link d-flex px-5">
															<span class="symbol symbol-20px me-4">
																<img class="rounded-1"
                                                                     src="{{  URL::asset('demo1/dist/assets/media/flags/germany.svg') }}"
                                                                     alt="metronic"/>
															</span>German</a>
                                                </div>
                                                <!--end::Menu item-->
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="account/settings.html" class="menu-link d-flex px-5">
															<span class="symbol symbol-20px me-4">
																<img class="rounded-1"
                                                                     src="{{  URL::asset('demo1/dist/assets/media/flags/france.svg') }}"
                                                                     alt="metronic"/>
															</span>French</a>
                                                </div>
                                                <!--end::Menu item-->
