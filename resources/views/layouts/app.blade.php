							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item menu-accordion">
									...
									<span class="menu-link">
										...
										<a class="menu-title" href="{{ route('tasks.index') }}">
									...
									<span class="menu-link">
										...
										<a href="{{ url('task-supervisor') }}">
											<span class="menu-title">Verify task</span>
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg" kt-hidden-height="116" style="display: none; overflow: hidden;">
										<div class="menu-item">
										...
										<div class="menu-item">
											<a class="menu-link" href="{{ route('supervisor.index') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									<span class="menu-link">
										...
										<span class="menu-title"><a  href="{{ route('logout') }}"
