...
<link href="{{  URL::asset('demo1/dist/assets/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet" type="text/css" />
		<!--end::Page Vendor Stylesheets-->
		<!--begin::Global Stylesheets Bundle(used by all pages)-->
		<link href="{{  URL::asset('demo1/dist/assets/plugins/global/plugins.bundle.css') }}" rel="stylesheet" type="text/css" />
		<link href="{{  URL::asset('demo1/dist/assets/css/style.bundle.css') }}" rel="stylesheet" type="text/css" />
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item menu-accordion">
									...
									<span class="menu-link">
										...
										<a class="menu-link" href="{{ route('tasklist.index') }}">
									...
									<span class="menu-link">
										...
										<a class="menu-link" href="{{ route('worklist.index') }}">
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									<span class="menu-link">
										...
										<span class="menu-title"><a class="nav-link"  href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                        <i class="ti-power-off"></i> <span class="hide-menu">Logout</span>
                                    </a>
									...
									<div class="d-flex align-items-stretch flex-shrink-0">
															...
															<div class="scroll-y mh-200px mh-lg-325px">
																...
																<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																	...
																	<div class="symbol symbol-40px me-4">
																		<img src="{{  URL::asset('demo1/dist/assets/media/avatars/150-1.jpg') }}" alt="" />
																	</div>
																	<!--end::Symbol-->
																	<!--begin::Title-->
																...
																<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																	<!--begin::Symbol-->
																	<div class="symbol symbol-40px me-4">
																		<img src="{{  URL::asset('demo1/dist/assets/media/avatars/150-3.jpg') }}" alt="" />
																	</div>
																	<!--end::Symbol-->
																	<!--begin::Title-->
																	<div class="d-flex flex-column justify-content-start fw-bold">
																...
																<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																	<!--begin::Symbol-->
																	<div class="symbol symbol-40px me-4">
																		<img src="{{  URL::asset('demo1/dist/assets/media/avatars/150-8.jpg') }}" alt="" />
																	</div>
																	<!--end::Symbol-->
																	<!--begin::Title-->
																	<div class="d-flex flex-column justify-content-start fw-bold">
																...
																<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																	<!--begin::Symbol-->
																	<div class="symbol symbol-40px me-4">
																		<img src="{{  URL::asset('demo1/dist/assets/media/avatars/150-12.jpg') }}" alt="" />
																	</div>
																	<!--end::Symbol-->
																	<!--begin::Title-->
																	<div class="d-flex flex-column justify-content-start fw-bold">
																...
																<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																	...
																	<div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px" src="{{  URL::asset('demo1/dist/assets/media/svg/misc/volicity-9.svg') }}" alt="" />
																		</span>
																	</div>
																	<!--end::Symbol-->
																	<!--begin::Title-->
																...
																<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																	...
																	<div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px" src="{{  URL::asset('demo1/dist/assets/media/svg/misc/infography.svg') }}" alt="" />
																		</span>
																	</div>
																	<!--end::Symbol-->
																	<!--begin::Title-->
																...
																<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																	...
																	<div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px" src="{{  URL::asset('demo1/dist/assets/media/svg/misc/leaf.svg') }}" alt="" />
																		</span>
																	</div>
																	<!--end::Symbol-->
																	<!--begin::Title-->
																...
																<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																	...
																	<div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px" src="{{  URL::asset('demo1/dist/assets/media/svg/misc/tower.svg') }}" alt="" />
																		</span>
																	</div>
																	<!--end::Symbol-->
																	<!--begin::Title-->
												...
												<div class="tab-content">
													...
													<div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
														...
														<div class="d-flex flex-column px-9">
															...
															<!--end::Section-->
															<!--begin::Illustration-->
															<img class="mh-200px" alt="metronic" src="{{  URL::asset('demo1/dist/assets/media/svg/illustrations/work.svg') }}" />
															<!--end::Illustration-->
														</div>
														<!--end::Wrapper-->
													</div>
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											...
											<div class="cursor-pointer symbol symbol-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
												<img src="{{  URL::asset('demo1/dist/assets/media/avatars/150-2.jpg') }}" alt="metronic" />
											</div>
											<!--begin::Menu-->
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="symbol symbol-50px me-5">
															<img alt="Logo" src="{{  URL::asset('demo1/dist/assets/media/avatars/150-2.jpg') }}" />
														</div>
														<!--end::Avatar-->
														<!--begin::Username-->
														<div class="d-flex flex-column">
												...
												<div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start" data-kt-menu-flip="center, top">
													<a href="#" class="menu-link px-5">
														...
														<img class="w-15px h-15px rounded-1 ms-2" src="{{  URL::asset('demo1/dist/assets/media/flags/united-states.svg') }}" alt="metronic" /></span></span>
													</a>
													<!--begin::Menu sub-->
													<div class="menu-sub menu-sub-dropdown w-175px py-4">
														<!--begin::Menu item-->
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div class="d-flex align-items-center py-1">
									...
									<!--end::Wrapper-->
									<!--begin::Button-->
									<a  class="btn btn-sm btn-primary"  href="{{ route('worklist.create') }}" >Create</a>
									<!--end::Button-->
								</div>
								<!--end::Actions-->
							</div>
	...
	<div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
             ...
             @if($submitbtn <= 7.2)
   <a class="btn btn-sm btn-primary" href="{{ route('tasklist.create') }}"> New Task</a>
...
@endif  
    ...
    @endif
        ...
        <tr>
	        ...
	        <td>{{ '8 hours' }}</td><td> {{ $loss_hours }}</td><td>{{ $assign_hour }}</td><td>{{ $available_hour }}</td><td>{{ $Entry_time }} min</td><td>{{ 'n' }}</td></tr></table>
		...
		<tbody class="list-group connectedSortable" id="padding-item-drop">
                  <tr><th>Timestamp</th>
           ...
           <th>Task Type</th>
            ...
            <th widtd="280px">Action</th></tr>
			@php $i=0 @endphp	@foreach($panddingItem as $key=>$value)
                      <tr class="list-group-item" item-id="{{ $value->id }}"> <td><a class="fs-6 text-gray-800 text-hover-primary" href="{{ route('tasklist.edit',$value->id) }}">{{ $value->Timestamp }}</a></td>
			<td><a class="fs-6 text-gray-800 text-hover-primary" href="{{ route('tasklist.edit',$value->id) }}">{{$i+1}}</a></td>
	        <td><a class="fs-6 text-gray-800 text-hover-primary" href="{{ route('tasklist.edit',$value->id) }}">{{ $value->Task_Shift}}</a></td>
			 <td><a class="fs-6 text-gray-800 text-hover-primary" href="{{ route('tasklist.edit',$value->id) }}">{{ $value->Task_type}}</a></td>
			 <td><a class="fs-6 text-gray-800 text-hover-primary" href="{{ route('tasklist.edit',$value->id) }}">{{ $value->Task_Title }}</a></td>
			 <td><a class="fs-6 text-gray-800 text-hover-primary" href="{{ route('tasklist.edit',$value->id) }}">{{ $value->Task_Details}}</a></td>
			 <td><a class="fs-6 text-gray-800 text-hover-primary" href="{{ route('tasklist.edit',$value->id) }}">{{ $value->Task_QTY}}</a></td>
			 <td><a class="fs-6 text-gray-800 text-hover-primary" href="{{ route('tasklist.edit',$value->id) }}">{{ $value->Time_acc_to_task}} </a></td>
			 <td><a class="fs-6 text-gray-800 text-hover-primary" href="{{ route('tasklist.edit',$value->id) }}">{{ $value->To_do_Time }} minute </a></td>
			 <td><a class="fs-6 text-gray-800 text-hover-primary" href="{{ route('tasklist.edit',$value->id) }}">{{ $value->Proposed_Time }}</a></td>
			 <td><a class="fs-6 text-gray-800 text-hover-primary" href="{{ route('tasklist.edit',$value->id) }}">{{ $value->Plan }}</a></td>
			 ...
			 <td>
                   ...
                   @if( $value->Start_Date == 0 )
                                                   ...
                                                   @elseif( $value->Start_Date != 0 && $value->Paused_Date == 0 )
                                                        
                                                        <div class="badge badge-light-info fw-bolder px-4 py-3">  Progress </div> 
											 @elseif( $value->Start_Date != 0 && $value->Paused_Date != 0 && $value->Resume_Date == 0)
                                                        
                                                        <div class="badge badge-light-danger fw-bolder px-4 py-3">  Paused </div> 
													@elseif( $value->Start_Date != 0 && $value->Paused_Date != 0 && $value->Resume_Date != 0 && $value->Complete_Date == 0)
                                                        <div class="badge badge-light-info fw-bolder px-4 py-3"> Progress</div>
													@elseif( $value->Start_Date !=  0 && $value->Paused_Date != 0 && $value->Resume_Date != 0  && $value->Complete_Date != 0 )
...
<script src="{{  URL::asset('demo1/dist/assets/plugins/global/plugins.bundle.js') }}"></script>
		<script src="{{  URL::asset('demo1/dist/assets/js/scripts.bundle.js') }}"></script>
		<!--end::Global Javascript Bundle-->
		<!--begin::Page Vendors Javascript(used by this page)-->
		<script src="{{  URL::asset('demo1/dist/assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
